...
export const ACTIVITIES: Activity[] = [
  ...
  // — King’s Highway castles & UNESCO towns —
  { id: 'act-karak', title: 'Karak Castle', emoji: '🏰', category: 'daytrip', region: 'petra', duration: 'Half day', popularity: 4, coords: [31.1809, 35.7017], description: 'A vast Crusader fortress on the King’s Highway with tunnels and ramparts high above the valley — the classic stop between the Dead Sea and Petra.' },
  { id: 'act-shobak', title: 'Shobak Castle (Montreal)', emoji: '🛡️', category: 'daytrip', region: 'petra', duration: '1–2 hrs', popularity: 3, coords: [30.5319, 35.5119], description: 'A lonely, atmospheric Crusader castle on a desert hilltop — an easy, uncrowded add-on about 40 min before Petra.' },
  { id: 'act-salt', title: 'As-Salt old town', emoji: '🏘️', category: 'daytrip', region: 'amman', duration: 'Half day', popularity: 4, familyPick: true, coords: [32.0392, 35.7275], description: 'UNESCO-listed “place of tolerance” — honey-colored Ottoman houses, staircases, the Harmony Trail, and a museum in the old English hospital. 40 min from Amman.' },
  { id: 'act-umm-rasas', title: 'Umm ar-Rasas mosaics', emoji: '🖼️', category: 'daytrip', region: 'madaba', duration: '1–2 hrs', popularity: 3, coords: [31.5003, 35.9217], description: 'A quiet UNESCO site with one of Jordan’s finest church-floor mosaics and a mysterious 15m stylite tower. Pairs with Madaba & Mount Nebo.' },
  { id: 'act-petra-high-place', title: 'Petra: High Place of Sacrifice hike', emoji: '🥾', category: 'nature', region: 'petra', duration: '2–3 hrs', popularity: 4, coords: [30.3222, 35.4416], description: 'A stepped climb to a clifftop altar with a bird’s-eye view over the whole valley — the best loop back down passes tombs most visitors miss.' },
  { id: 'act-dead-sea-panorama', title: 'Dead Sea Panorama & Museum', emoji: '🌅', category: 'relax', region: 'deadsea', duration: '1–2 hrs', popularity: 3, coords: [31.6003, 35.5936], description: 'A dramatic clifftop terrace high above the sea with a small geology museum and a café — unbeatable at sunset.' },
  { id: 'act-iraq-al-amir', title: 'Iraq al-Amir & the caves', emoji: '🪨', category: 'daytrip', region: 'amman', duration: 'Half day', popularity: 3, coords: [31.9111, 35.7517], description: 'A green valley just west of Amman with the Hellenistic Qasr al-Abd palace and a women’s craft cooperative — a pretty, low-key half day.' },
]
...
export const RESTAURANTS: Restaurant[] = [
  ...
  // — More Amman favorites (blog & local darlings) —
  { id: 'res-jafra', name: 'Jafra Café', emoji: '🎶', cuisine: 'Traditional Jordanian', neighborhood: 'Downtown (Al-Balad)', region: 'amman', vibe: 'Nostalgic first-floor institution', price: 1, signature: 'Mezze, argileh & live oud nights', orderIn: false, popularity: 4, coords: [31.9508, 35.9339], description: 'A downtown classic up a worn staircase — vintage posters, Fairuz on the speakers, and the city’s most atmospheric breakfast or late tea.' },
  { id: 'res-books-cafe', name: 'Books@Cafe', emoji: '📚', cuisine: 'Café & international', neighborhood: 'Rainbow Street', region: 'amman', vibe: 'Bookshop-café with a view terrace', price: 2, signature: 'All-day brunch & smoothies over downtown', orderIn: true, popularity: 4, coords: [31.9503, 35.9271], description: 'The Middle East’s first internet café, still a Rainbow Street landmark — a bookshop below, a buzzing rooftop above.' },
  { id: 'res-tawaheen', name: 'Tawaheen Al-Hawa', emoji: '🌬️', cuisine: 'Mezze & grills', neighborhood: 'Sweifieh / Airport Rd', region: 'amman', vibe: 'Grand feast-hall for big tables', price: 2, signature: 'Endless hot & cold mezze, then mixed grill', orderIn: true, popularity: 4, familyPick: true, coords: [31.9436, 35.855], description: 'The go-to for a proper Jordanian mezze blowout with a crowd — dozens of little plates before the charcoal even arrives.' },
  { id: 'res-kanzaman', name: 'Kan Zaman', emoji: '🎻', cuisine: 'Traditional village dining', neighborhood: 'Al-Yadudah (south of Amman)', region: 'amman', vibe: 'Restored Ottoman village & folklore', price: 2, signature: 'Mansaf & mezze under stone arches', orderIn: false, popularity: 4, coords: [31.8333, 35.9333], description: 'A 19th-century village turned dining destination — craft stalls, live music, and a big traditional spread. A fun family evening out.' },
  { id: 'res-zwz', name: 'Za’atar w Zeit', emoji: '🫓', cuisine: 'Manakish & Levantine café', neighborhood: 'Multiple branches', region: 'amman', vibe: 'Reliable all-day café chain', price: 2, signature: 'Za’atar manakish & fatteh', orderIn: true, popularity: 3, coords: [31.9535, 35.8712], description: 'The dependable, open-late spot for manakish, wraps, and breakfast at any hour — great when the group can’t agree.' },
  { id: 'res-rakwet-arab', name: 'Rakwet Arab', emoji: '☕', cuisine: 'Traditional café', neighborhood: 'Jabal al-Weibdeh', region: 'amman', vibe: 'Old-Amman living-room vibe', price: 1, signature: 'Sahlab, Turkish coffee & simple mezze', orderIn: false, popularity: 3, coords: [31.9558, 35.9240], description: 'A cozy Weibdeh favorite for slow mornings and long conversations over coffee and a light Levantine breakfast.' },
  { id: 'res-gerard', name: 'Gerard', emoji: '🍦', cuisine: 'Ice cream & desserts', neighborhood: 'Rainbow Street', region: 'amman', vibe: 'The Rainbow Street ice-cream stop', price: 1, signature: 'Scoops after a downtown evening', orderIn: false, popularity: 4, coords: [31.9497, 35.9259], description: 'The end-of-the-night ice cream ritual on Rainbow Street since the 1980s — join the queue and stroll.' },
  { id: 'res-romero', name: 'Romero', emoji: '🍤', cuisine: 'Italian & seafood', neighborhood: 'Aqaba', region: 'aqaba', vibe: 'Long-standing smart dinner spot', price: 3, signature: 'Pasta & Red Sea seafood', orderIn: false, popularity: 3, coords: [29.5289, 35.0061], description: 'Aqaba’s reliable upscale Italian by the shore — a calmer alternative to the harbor fish houses.' },
]
